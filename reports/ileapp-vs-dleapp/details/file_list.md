...
**ileapp** (baseline) vs **dleapp** (comparison)

| Logical path | Status | Baseline | Comparison |
|---|---|---|---|
| `main_entry.py` | logic_changed | `ileapp.py` | `dleapp.py` |
| `main_gui.py` | logic_changed | `ileappGUI.py` | `dleappGUI.py` |
...
| `scripts/roblox.py` | expected_repo_specific | `—` | `scripts/roblox.py` |
| `scripts/signal_desktop.py` | expected_repo_specific | `—` | `scripts/signal_desktop.py` |
| `scripts/telegram.py` | expected_repo_specific | `—` | `scripts/telegram.py` |
